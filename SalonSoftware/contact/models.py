...
class Contact(models.Model):
    ...
    middle_name = models.CharField(
        max_length=30, null=True, blank=True, verbose_name=("Middle Name")
    )
    last_name = models.CharField(
        max_length=30, null=True, blank=True, verbose_name=("Last Name")
    )
    ...
    username = models.CharField(
        max_length=30, null=True, blank=True, verbose_name=("Username")
    )
    email = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=("Email")
    )
    ...
    password = models.CharField(
        max_length=200, null=True, blank=True, verbose_name="password"
    )
    company_name = models.CharField(
        max_length=30, null=True, blank=True, verbose_name=("Company Name")
    )
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, null=True, blank=True, verbose_name=("User")
    )
