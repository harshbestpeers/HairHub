...
class Salon(models.Model):
    ...
    salon_type = models.CharField(max_length=32, choices=SALON_TYPE_CHOICES, default='unisex', verbose_name=('Salon Type'))
...
class Staff(models.Model):
    ...
    specialization = models.CharField(max_length=32, choices=STAFF_TYPE_CHOICES, default='Hair Stylists', verbose_name=('specialization'))
...
class SalonService(models.Model):
    ...
    salon = models.ForeignKey(Salon, on_delete=models.SET_NULL, null=True, blank=True, verbose_name=('salon'), related_name="salonservice")
...
class Appointment(models.Model):
    ...
    customer = models.ForeignKey('contact.Contact', on_delete=models.CASCADE, related_name='appointments', blank=True, null=True)
    service = models.ForeignKey(SalonService, on_delete=models.CASCADE, blank=True, null=True)
    staff = models.ForeignKey(Staff, on_delete=models.SET_NULL, null=True, blank=True)
    salon = models.ForeignKey(Salon, on_delete=models.CASCADE, related_name='appointments', blank=True, null=True)
...
class SalonReview(models.Model):
    rating = models.PositiveSmallIntegerField(choices=[(i, i) for i in range(1, 6)], null=True, blank=True)  # 1 to 5 star rating
...
class SalonImage(models.Model):
    ...
    salon = models.ForeignKey(Salon, on_delete=models.CASCADE, related_name='images', null=True, blank=True)
    service = models.ForeignKey(SalonService, on_delete=models.CASCADE, related_name='images', null=True, blank=True)
    user = models.ForeignKey('contact.Contact', on_delete=models.CASCADE, related_name='images', null=True, blank=True)
